...
REMOVE_LEADING_TRAILING_DEFAULT = True
REMOVE_SPACES_DEFAULT = True
PLACEHOLDER_DEFAULT = None
PREFILL_DEFAULT = None
ALLOW_BLANK_DEFAULT = True
IGNORE_CASE_DEFAULT = True
SIZE_DEFAULT = 35
SHOW_HELP_TEXT_DEFAULT = False
QPANEL_BADGES_DEFAULT = False


def prepare(element_html, data):
    element = lxml.html.fragment_fromstring(element_html)
    required_attribs = ['answers-name']
    optional_attribs = ['weight', 'correct-answer', 'label', 'suffix', 'display', 'remove-leading-trailing', 'remove-spaces', 'allow-blank', 'ignore-case', 'placeholder', 'size', 'show-help-text', 'prefill', 'qpanel-badges']
...
def render(element_html, data):
    ...
    qpanel_badges = pl.get_string_attrib(element, 'qpanel-badges', PREFILL_DEFAULT)
    ...
    if data['panel'] == 'question':
        ...
        with open('pl-string-embed.mustache', 'r', encoding='utf-8') as f:
            template = f.read()
