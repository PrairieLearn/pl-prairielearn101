class MemoryUtils {
    ...
    static removeHighlight() {
        this.userData.removeHighlight();
        this.kernelData.removeHighlight();
        this.stack.removeHighlight();
    }
...
class Memory {
    ...
    /**
     * Remove highlighting from memory values
     */
    removeHighlight() {
    }
...
class UserData extends DataSegment {
    ...
    removeHighlight() {
        this.lines.forEach(e => e.removeHighlight());
    }
}
