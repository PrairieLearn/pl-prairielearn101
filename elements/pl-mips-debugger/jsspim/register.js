class RegisterUtils {
    ...
    static removeHighlight() {
        this.generalRegs.forEach(reg => reg.removeHighlight());
        this.specialIntRegs.forEach(reg => reg.removeHighlight());
        this.specialFloatRegs.forEach(reg => reg.removeHighlight());
        this.floatRegs.forEach(reg => reg.removeHighlight());
        this.doubleRegs.forEach(reg => reg.removeHighlight());
    }
