class PushButton extends PLDrawingBaseElement {
  ...
  static get_button_tooltip(options) {
    return 'Add a push-button switch';
  }

  static get_button_icon() {
    return 'push-button-icon.svg';
  }
}

PLDrawingApi.registerElements('push-button', {
  'pl-push-button': PushButton,
});
