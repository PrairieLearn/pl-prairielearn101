class ResistorVariable extends PLDrawingBaseElement {
  ...
  static get_button_tooltip(options) {
    return 'Add ' + options.rvartype + ' sensitive resistor';
  }

  static get_button_icon() {
    return 'rvar-icon.svg';
  }
}

PLDrawingApi.registerElements('rvar', {
  'pl-rvar': ResistorVariable,
});
