...
`define OP_JRME     6'h3b
`define OP_LWINN    6'h3b
`define OP_LWSIN    6'h3b
`define OP_RETI     6'h3b
`define OP_SWNE     6'h3b
`define OP_SWPLUS   6'h3b

////
//// Custon function codes
////

`define OP0_ABS     6'h2c
`define OP0_ASIN    6'h2c
`define OP0_JRIA    6'h2c
`define OP0_JRLT    6'h2c
`define OP0_LOOP    6'h2c
`define OP0_MAX     6'h2c
`define OP0_MOVZ    6'h0a
`define OP0_PUSH    6'h2c
