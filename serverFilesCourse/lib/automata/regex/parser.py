...
from lib.automata.base.utils import get_renaming_function, pairwise
from lib.automata.regex.lexer import Lexer, Token
from lib.automata.regex.postfix import (
    InfixOperator,
    LeftParen,
    Literal,
    PostfixOperator,
