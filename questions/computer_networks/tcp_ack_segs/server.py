...
def generate(data):
    ...
    data['params']['segs'] = [{'start': data['params']['isn'] + i*1448, 'end': data['params']['isn'] + (i+1)*1448} for i in range(8)]
    data['params']['ack'] = data['params']['isn'] + random.choice([1,2,3,4,5])*1448
