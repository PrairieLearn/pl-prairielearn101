...
def generate(data):
    ...
    scenarios = [
        {
            "description": "Dr. Alford really loves tacos. One time, she had tacos for breakfast, lunch, AND dinner -- what a great day! Here is Dr. Alford's process for making a basic taco that she likes:",
        ...
        {
            "description": "Dr. Alford really loves tacos, including fajitas! Here is Dr. Alford's process for making a basic fajita/taco that she likes",
