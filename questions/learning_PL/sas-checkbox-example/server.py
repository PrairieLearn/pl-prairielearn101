...
def generate(data):
    ...
    scenarios = [
        {
            "description": "Here is a portion of the lyrics to the University of Michigan Fight Song, <i>The Victors</i>:",
            "song": "The Victors",
            "lyrics": [
        ...
        {
            "description": "Here is a portion of the lyrics to the University of Michigan Alma Mater, <i>The Yellow and Blue</i>:",
