...
def generate(data):
    ...
    scenarios = [
        {
            "question": "Which of these movies got Prof. Alford interested in computer programming back when she was a teenager?",
        ...
        {
            "question": "Which of these video games did Prof. Alford LOVE LOVE LOVE to play growing up?",
        ...
        {
            "question": "What is Prof. Alford's favorite color?",
            "correct": ["yellow"],
            "wrong": [ "blue", "green", "teal", "red", "brown", "orange","purple","black","white","magenta","hot pink"]
        },
        {
            "question": "What did Prof. Alford major in for undergrad?",
