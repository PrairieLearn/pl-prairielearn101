...
# This is a driver program that 



# This problem is about Cheng's Squirrel Boutique. The original question was in the W21 C++ exam.
...
def generate(data):
    ...
    # original info from Crabster
    scenarios = [
        {
            "theme": {
                "company": "Cheng's Squirrel Boutique",
                "goods": "knitted hockey sweaters for squirrels",
                "goods_short": "hockey sweaters",
                "goods_singular": "hockey sweater",
                "radius": "75 mile"
            },
            "part_struct": {
                "name": "Sweater",
                "plural_name": "Sweaters",
                "var_name": "sweater",
                "english_name": "sweater",
                "english_name_plural": "sweaters",
                "mem1": {
                    "name": "material",
                    "description": "the material the item is made of",
                    "examples": "`\"wool\"`, `\"hemp\"`, `\"acrylic\"`",
                    "type": "string",
                    "distractor_types": ["char","int","bool","vector","double"]
                },
                "mem2": {
                    "name": "price",
                    "description": "the price of the item in U.S. dollars",
                    "examples": "`76.50`, `25.99`, `149.99`",
                    "type": "double",
                    "distractor_types": ["char","int","bool","vector","string"]
                },
                "mem3": {
                    "name": "forSquirrels",
                    "description": "whether or not the item is for squirrels",
                    "type": "bool",
                    "distractor_types": ["char","int","string","vector","double"]
                }
            },
            "group_struct": {
                "name": "Store",
            ...
            "driver": {
                "name": "checkStoreData",
                "success_message": "Awesome! Open a new store.",
                "failure_message": "You should not open a new store at this time.",
    ...
    # save data for PrairieLearn

    data['params']['theme_company'] = scenarios[0]["theme"]["company"]
    data['params']['theme_goods'] =  scenarios[0]["theme"]["goods"]
    data['params']['theme_goods_short'] =  scenarios[0]["theme"]["goods_short"]
    data['params']['theme_goods_singular'] =  scenarios[0]["theme"]["goods_singular"]
    data['params']['theme_radius'] =  scenarios[0]["theme"]["radius"]

    data['params']['part_struct_name'] =  scenarios[0]["part_struct"]["name"]
    data['params']['part_struct_plural_name'] =  scenarios[0]["part_struct"]["plural_name"]
    data['params']['part_struct_var_name'] =  scenarios[0]["part_struct"]["var_name"]
    data['params']['part_struct_english_name'] =  scenarios[0]["part_struct"]["english_name"]
    data['params']['part_struct_english_name_plural'] =  scenarios[0]["part_struct"]["english_name_plural"]

    data['params']['part_struct_mem1_name'] =  scenarios[0]["part_struct"]["mem1"]["name"]
    data['params']['part_struct_mem1_description'] =  scenarios[0]["part_struct"]["mem1"]["description"]
    data['params']['part_struct_mem1_examples'] =  scenarios[0]["part_struct"]["mem1"]["examples"]
    data['params']['part_struct_mem1_type'] =  scenarios[0]["part_struct"]["mem1"]["type"]

    data['params']['part_struct_mem2_name'] =  scenarios[0]["part_struct"]["mem2"]["name"]
    data['params']['part_struct_mem2_description'] =  scenarios[0]["part_struct"]["mem2"]["description"]
    data['params']['part_struct_mem2_examples'] =  scenarios[0]["part_struct"]["mem2"]["examples"]
    data['params']['part_struct_mem2_type'] =  scenarios[0]["part_struct"]["mem2"]["type"]

    data['params']['part_struct_mem3_name'] =  scenarios[0]["part_struct"]["mem3"]["name"]
    data['params']['part_struct_mem3_description'] =  scenarios[0]["part_struct"]["mem3"]["description"]
    data['params']['part_struct_mem3_type'] =  scenarios[0]["part_struct"]["mem3"]["type"]


    data['params']['group_struct_name'] =  scenarios[0]["group_struct"]["name"]
    data['params']['group_struct_english_name'] =  scenarios[0]["group_struct"]["english_name"]
    data['params']['group_struct_var_name'] =  scenarios[0]["group_struct"]["var_name"]
    data['params']['group_struct_vector'] =  scenarios[0]["group_struct"]["vector"]

    data['params']['group_struct_mem_vector_name'] =  scenarios[0]["group_struct"]["mem_vector"]["name"]
    data['params']['group_struct_mem_name_name'] =  scenarios[0]["group_struct"]["mem_name"]["name"]
    data['params']['group_struct_mem_name_type'] =  scenarios[0]["group_struct"]["mem_name"]["type"]
    data['params']['group_struct_mem_address_name'] =  scenarios[0]["group_struct"]["mem_address"]["name"]
    data['params']['group_struct_mem_address_type'] =  scenarios[0]["group_struct"]["mem_address"]["type"]
    data['params']['group_struct_mem_revenue_name'] =  scenarios[0]["group_struct"]["mem_revenue"]["name"]
    data['params']['group_struct_mem_revenue_type'] =  scenarios[0]["group_struct"]["mem_revenue"]["type"]

    data['params']['library_name'] =  scenarios[0]["library"]["name"]
    data['params']['library_analyze_function_name'] =  scenarios[0]["library"]["analyze_function"]["name"]
    data['params']['library_analyze_function_output_name'] =  scenarios[0]["library"]["analyze_function"]["output_name"]
    data['params']['library_summary_function_name'] =  scenarios[0]["library"]["summary_function"]["name"]

    data['params']['driver_name'] =  scenarios[0]["driver"]["name"]
    data['params']['driver_success_message'] =  scenarios[0]["driver"]["success_message"]
    data['params']['driver_failure_message'] =  scenarios[0]["driver"]["failure_message"]
    data['params']['driver_output_file'] =  scenarios[0]["driver"]["output_file"]
    ...
    answer = { 
        'tag': 'true', 
        'ans': scenarios[0]["part_struct"]["mem1"]["type"]
    }
    answers.append(answer)

    for i in range(len(scenarios[0]["part_struct"]["mem1"]["distractor_types"])):
        answer = { 
            'tag': 'false', 
            'ans': scenarios[0]["part_struct"]["mem1"]["distractor_types"][i]
        }
        answers.append(answer)

    data['params']['struct1_types'] = answers
    ...
    answer = { 
        'tag': 'true', 
        'ans': scenarios[0]["part_struct"]["mem2"]["type"]
    }
    answers.append(answer)

    for i in range(len(scenarios[0]["part_struct"]["mem2"]["distractor_types"])):
        answer = { 
            'tag': 'false', 
            'ans': scenarios[0]["part_struct"]["mem2"]["distractor_types"][i]
        }
        answers.append(answer)

    data['params']['struct2_types'] = answers
    ...
    answer = { 
        'tag': 'true', 
        'ans': scenarios[0]["part_struct"]["mem3"]["type"]
    }
    answers.append(answer)

    for i in range(len(scenarios[0]["part_struct"]["mem3"]["distractor_types"])):
        answer = { 
            'tag': 'false', 
            'ans': scenarios[0]["part_struct"]["mem3"]["distractor_types"][i]
        }
        answers.append(answer)

    data['params']['struct3_types'] = answers
