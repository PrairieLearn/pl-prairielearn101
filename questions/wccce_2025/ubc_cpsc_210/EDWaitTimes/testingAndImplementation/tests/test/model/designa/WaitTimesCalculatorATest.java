...
public class WaitTimesCalculatorATest {
    ...
    @Test
    @Grader
    @Hint("Design A: Test for getRequiredGroups for HOUR_OF_DAY")
    ...
    @Test
    @Grader
    @Hint("Design A: Test for getGroupingLabel for HOUR_OF_DAY")
    ...
    @Hint("Design A: Test of grouping for AM Hours for HOUR_OF_DAY")
    @Grader
    public void testAMHours(int hour, String expectedGroup) {
        testWaitTimeGroupingHour(hour, expectedGroup);
    }
    ...
    @Test
    @Grader
    @Hint("Design A: Test of grouping for noon for HOUR_OF_DAY")
    ...
    @Grader
    @Hint("Design A: Test of grouping for PM Hours for HOUR_OF_DAY")
    ...
    @Grader
    @Hint("Design A original functionality")
    @Test
